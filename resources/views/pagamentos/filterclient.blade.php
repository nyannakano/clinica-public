...
@section('content')
    ...
    <h1>Contas a Receber do Cliente: {{ $cliente->clie_name }}</h1>
    ...
    {{--        <a href="{{ route('pagamentos.index') }}"><span class="badge badge-primary">Todos</span></a>--}}
    {{--        <a href="{{ route('pagamentos.filter', [ 'type' => 0]) }}"><span class="badge badge-secondary">Em Aberto</span></a>--}}
    {{--        <a href="{{ route('pagamentos.filter', [ 'type' => 1]) }}"><span class="badge badge-success">Quitado</span></a>--}}
    {{--        <a href="{{ route('pagamentos.filter', [ 'type' => 2]) }}"><span class="badge badge-danger">Cancelado</span></a>--}}
